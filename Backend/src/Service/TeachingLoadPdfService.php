...
class TeachingLoadPdfService
{
    ...
    private function calculateTotals(array $schedules, ?string $semester = null): array
    {
        ...
        foreach ($schedules as $schedule) {
            ...
            // Use actual enrolled students from the schedule record.
            $totalStudents += max(0, (int) ($schedule->getEnrolledStudents() ?? 0));
    ...
    private function generateScheduleRows(TCPDF $pdf, array $schedules, array $colWidths, float $startX): void
    {
        ...
        foreach ($schedules as $schedule) {
            ...
            $students = (string) max(0, (int) ($schedule->getEnrolledStudents() ?? 0));
