...
class AdminController extends AbstractController
{
    ...
    {
        return $this->render('admin/schedule_change_requests/index.html.twig', array_merge($this->getBaseTemplateData(), [
    ...
    public function exportFacultyTeachingHistory(int $id, Request $request): Response
    {
        ...
        foreach ($teachingHistory as $schedule) {
            $csv[] = [
                ...
                $schedule->getStartTime() ? $schedule->getStartTime()->format('g:i A') : 'N/A',
                $schedule->getEndTime() ? $schedule->getEndTime()->format('g:i A') : 'N/A',
            ];
        }
