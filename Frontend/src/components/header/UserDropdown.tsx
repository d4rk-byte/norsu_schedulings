...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 flex items-center justify-center h-11 w-11 rounded-full bg-brand-500 text-white font-semibold text-sm">
          {initials}
        </span>

        <span className="block mr-1 font-medium text-theme-sm">{user?.firstName || displayName}</span>
      ...
      >
        <div>
          ...
          {roleLabel && (
            <span className="mt-1 inline-block rounded-full bg-brand-50 px-2 py-0.5 text-theme-xs font-medium text-brand-600 dark:bg-brand-500/10 dark:text-brand-400">
              {roleLabel}
            </span>
          )}
        </div>
