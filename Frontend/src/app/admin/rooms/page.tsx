...
export default function RoomsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {list.error && <Alert variant="error">Failed to load rooms: {list.error}</Alert>}
      ...
      <Card>
        <div className="mb-4 space-y-3">
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
            <SearchBar value={list.search} onChange={list.setSearch} placeholder="Search rooms..." className="w-full sm:max-w-sm" />
